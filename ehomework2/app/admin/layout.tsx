    ...
    <div style={{ minHeight: "100vh" }}>
      ...
      <aside className="admin-sidebar">
        ...
        <nav className="admin-sidebar-nav">
          ...
          <Link href="/admin/homework-capture" className="admin-sidebar-link">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" aria-hidden>
              <path d="M0 5a2 2 0 012-2h7.5a2 2 0 012 2v6a2 2 0 01-2 2H2a2 2 0 01-2-2V5zm2-1a1 1 0 00-1 1v6a1 1 0 001 1h7.5a1 1 0 001-1V5a1 1 0 00-1-1H2z" />
              <path d="M14 7a1 1 0 011 1v5a1 1 0 01-1 1h-3a1 1 0 01-1-1V8a1 1 0 011-1h3z" />
            </svg>
            Tab capture
          </Link>
